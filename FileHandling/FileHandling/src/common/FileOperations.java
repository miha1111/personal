...
//    this method write all information from list's of list named "all" into file "fileName"
	...
	public int numOfLines (String fileName, List<List<String>> all) {		// returns numbers of lines and save file "fileName" to cache as variable "all"
		int num = 0;
		BufferedReader in = null;
		String str = null;
	...
	public int numOfLinesHash (String fileName, HashMap<String, String> allGospodinjciHash, int hashIDColumn, int hashDataColumn) {		// returns numbers of lines and save file "fileName" to HashMap as variable "allGospodinjciHash"
		int num = 0;
		BufferedReader in = null;
		String str = null;
		List <String> listOfStr = null;
